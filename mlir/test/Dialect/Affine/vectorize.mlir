...
// CHECK-NEXT:   affine.for %arg2 = 0 to 1024 step 8 {
// CHECK-NEXT:     %[[V:.*]] = affine.load %[[VEC]][%arg1, %arg2 floordiv 8] : memref<2048x256xvector<8xf32>>
// CHECK-NEXT:     affine.store %[[V]], %[[VEC]][%arg1, %arg2 floordiv 8] : memref<2048x256xvector<8xf32>>
// CHECK-NEXT:   }
// CHECK-NEXT: }
...
// CHECK-NEXT:    affine.for %arg4 = 0 to 2048 step 4 {
...
// CHECK-NEXT:        %4 = affine.load %1[%arg5, %arg4 floordiv 4] : memref<2048x512xvector<4xf64>>
// CHECK-NEXT:        %5 = affine.load %0[%arg3, %arg4 floordiv 4] : memref<2048x512xvector<4xf64>>
// CHECK-NEXT:        %6 = mulf %3, %4 : vector<4xf64>
// CHECK-NEXT:        %7 = addf %5, %6 : vector<4xf64>
// CHECK-NEXT:        affine.store %7, %0[%arg3, %arg4 floordiv 4] : memref<2048x512xvector<4xf64>>
// CHECK-NEXT:      }
// CHECK-NEXT:    }
// CHECK-NEXT:  }
// CHECK-NEXT:  return
...
// CHECK-NEXT:   affine.for %arg9 = 0 to 16 step 8 {
// CHECK-NEXT:     %2 = affine.load %1[%arg4 * 512 + %arg8, %arg6 * 2 + %arg9 floordiv 8] : memref<2048x256xvector<8xf32>>
...
// CHECK-NEXT:       %5 = affine.load %0[%arg7 * 4 + %arg10, %arg6 * 2 + %arg9 floordiv 8] : memref<2048x256xvector<8xf32>>
// CHECK-NEXT:       %6 = mulf %4, %2 : vector<8xf32>
// CHECK-NEXT:       %7 = addf %5, %6 : vector<8xf32>
// CHECK-NEXT:       affine.store %7, %0[%arg7 * 4 + %arg10, %arg6 * 2 + %arg9 floordiv 8] : memref<2048x256xvector<8xf32>>
// CHECK-NEXT:     }
// CHECK-NEXT:   }
// CHECK-NEXT: }
          }
