...
module attributes {gpu.container_module}  {
  ...
  gpu.module @main_kernel {
    gpu.func @main_kernel(%C: memref<1024x1024xf32>, %B: memref<1024x1024xf16>, %A: memref<1024x1024xf16>) workgroup(%12 : memref<64x64xf16, 3>, %13 : memref<64x64xf16, 3>) kernel {
      %c128 = constant 128 : index
      ...
      scf.for %arg3 = %16 to %c64 step %c64 {
        ...
        scf.for %arg4 = %17 to %c64 step %c64 {
          ...
          %20 = gpu.subgroup_mma_load_matrix %C[%18, %19] {leadDimension = 1024 : index, operand = "COp"} : memref<1024x1024xf32> -> !gpu.mmafragment<8, f32>
          %21 = addi %10, %arg3 : index
          %22 = addi %21, %c16 : index
          %23 = addi %11, %arg4 : index
          %24 = gpu.subgroup_mma_load_matrix %C[%22, %23] {leadDimension = 1024 : index, operand = "COp"} : memref<1024x1024xf32> -> !gpu.mmafragment<8, f32>
          %25 = addi %10, %arg3 : index
          %26 = addi %11, %arg4 : index
          %27 = addi %26, %c16 : index
          %28 = gpu.subgroup_mma_load_matrix %C[%25, %27] {leadDimension = 1024 : index, operand = "COp"} : memref<1024x1024xf32> -> !gpu.mmafragment<8, f32>
          %29 = addi %10, %arg3 : index
          %30 = addi %29, %c16 : index
          %31 = addi %11, %arg4 : index
          %32 = addi %31, %c16 : index
          %33 = gpu.subgroup_mma_load_matrix %C[%30, %32] {leadDimension = 1024 : index, operand = "COp"} : memref<1024x1024xf32> -> !gpu.mmafragment<8, f32>
          %34:4 = scf.for %arg5 = %c0 to %c1024 step %c64 iter_args(%arg6 = %20, %arg7 = %24, %arg8 = %28, %arg9 = %33) -> (!gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>) {
            ...
            %45:4 = scf.for %arg10 = %c0 to %c64 step %c16 iter_args(%arg11 = %arg6, %arg12 = %arg7, %arg13 = %arg8, %arg14 = %arg9) -> (!gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>) {
              ...
              %48 = gpu.subgroup_mma_compute %46, %47, %arg11 : !gpu.mmafragment<8, vector<2xf16>>, !gpu.mmafragment<8, vector<2xf16>>, !gpu.mmafragment<8, f32> -> !gpu.mmafragment<8, f32>
              ...
              %52 = gpu.subgroup_mma_compute %50, %51, %arg12 : !gpu.mmafragment<8, vector<2xf16>>, !gpu.mmafragment<8, vector<2xf16>>, !gpu.mmafragment<8, f32> -> !gpu.mmafragment<8, f32>
              ...
              %56 = gpu.subgroup_mma_compute %53, %55, %arg13 : !gpu.mmafragment<8, vector<2xf16>>, !gpu.mmafragment<8, vector<2xf16>>, !gpu.mmafragment<8, f32> -> !gpu.mmafragment<8, f32>
              ...
              %61 = gpu.subgroup_mma_compute %58, %60, %arg14 : !gpu.mmafragment<8, vector<2xf16>>, !gpu.mmafragment<8, vector<2xf16>>, !gpu.mmafragment<8, f32> -> !gpu.mmafragment<8, f32>
              scf.yield %48, %52, %56, %61 : !gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>
            }
            gpu.barrier
            scf.yield %45#0, %45#1, %45#2, %45#3 : !gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>, !gpu.mmafragment<8, f32>
          }
          gpu.subgroup_mma_store_matrix %34#0, %C[%18, %19] {leadDimension = 1024 : index} : !gpu.mmafragment<8, f32>, memref<1024x1024xf32>
          gpu.subgroup_mma_store_matrix %34#1, %C[%22, %23] {leadDimension = 1024 : index} : !gpu.mmafragment<8, f32>, memref<1024x1024xf32>
          gpu.subgroup_mma_store_matrix %34#2, %C[%25, %27] {leadDimension = 1024 : index} : !gpu.mmafragment<8, f32>, memref<1024x1024xf32>
          gpu.subgroup_mma_store_matrix %34#3, %C[%30, %32] {leadDimension = 1024 : index} : !gpu.mmafragment<8, f32>, memref<1024x1024xf32>
        }
      }
      gpu.return
    }
